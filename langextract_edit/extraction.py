...
"""Main extraction API for langextract_edit."""
...
from langextract_edit import annotation
from langextract_edit import factory
from langextract_edit import io
from langextract_edit import prompting
from langextract_edit import resolver
...
def extract(
  ...
  Args:
      ...
      api_key: API key for Gemini or other LLM services (can also use
        environment variable langextract_edit_API_KEY). Cost considerations: Most
      ...
      debug: Whether to enable debug logging. When True, enables detailed logging
        of function calls, arguments, return values, and timing for the langextract_edit
  ...
  if debug:
    ...
    from langextract_edit.core import debug_utils
