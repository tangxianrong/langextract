...
"""Compatibility shim for langextract_edit.schema imports."""
...
def __getattr__(name: str):
  moved = {
      ...
      "GeminiSchema": ("langextract_edit.providers.schemas.gemini", "GeminiSchema"),
  }
  if name in moved:
    mod, attr = moved[name]
    warnings.warn(
        f"`langextract_edit.schema.{name}` is deprecated and will be removed in"
