...
BUILTIN_PROVIDERS: list[ProviderConfig] = [
    {
        ...
        'target': 'langextract_edit.providers.gemini:GeminiLanguageModel',
        'priority': patterns.GEMINI_PRIORITY,
    },
    {
        'patterns': patterns.OLLAMA_PATTERNS,
        'target': 'langextract_edit.providers.ollama:OllamaLanguageModel',
        'priority': patterns.OLLAMA_PRIORITY,
    },
    {
        'patterns': patterns.OPENAI_PATTERNS,
        'target': 'langextract_edit.providers.openai:OpenAILanguageModel',
