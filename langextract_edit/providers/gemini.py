...
"""Gemini provider for langextract_edit."""
...
from langextract_edit.providers import schemas
  ...
  def __init__(
    ...
    try:
      ...
      raise exceptions.InferenceConfigError(
          'Failed to import google-genai. Reinstall: pip install langextract_edit'
      ) from e
