...
_BUILTINS: Dict[str, str] = {
    "gemini": "langextract_edit.providers.gemini:GeminiLanguageModel",
    "ollama": "langextract_edit.providers.ollama:OllamaLanguageModel",
}

# Optional built-in providers (require extra dependencies)
_OPTIONAL_BUILTINS: Dict[str, str] = {
    "openai": "langextract_edit.providers.openai:OpenAILanguageModel",
}
...
def _discovered() -> Dict[str, str]:
  ...
  for ep in _safe_entry_points("langextract_edit.providers"):
